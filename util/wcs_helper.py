# modified version of https://github.com/astropy/reproject/blob/main/reproject/mosaicking/wcs_helpers.py
...
from reproject.utils import parse_input_shape

__all__ = ["find_optimal_celestial_wcs"]
    
def find_optimal_celestial_wcs(
    input_data, frame=None, projection="TAN", resolution=None, reference=None,
    rotate=None
):
    """
